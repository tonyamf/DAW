...
<table class="table">
  ...
  {foreach $products_order as $order}
    <tr>
      <th scope="row">  <img class="img-responsive" src="{$order.image}" alt="prewiew" width="120" height="80"></th>
      <td><b>{$order.name} </b> <h6>
...
<br>
  <a href="{$voltar}"><button class="btn btn-info" type="button">Voltar</button></a>
    </div>
